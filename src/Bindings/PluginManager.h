...
public:
	...
	bool CallHookServerPing               (cClientHandle & a_ClientHandle, AString & a_ServerDescription, size_t & a_OnlinePlayersCount, size_t & a_MaxPlayersCount, AString & a_Favicon);
